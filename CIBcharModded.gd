...
func createBodyparts():
    ...
    giveBodypartUnlessSame(GlobalRegistry.createBodypart("anuswombhyperable"))
    ...
    breasts.size = 20 # size T
    giveBodypartUnlessSame(breasts)
    giveBodypartUnlessSame(GlobalRegistry.createBodypart("synthtail"))
    giveBodypartUnlessSame(GlobalRegistry.createBodypart("synthlegsskin"))
    giveBodypartUnlessSame(GlobalRegistry.createBodypart("dragonearless"))
    giveBodypartUnlessSame(GlobalRegistry.createBodypart("dragonheadV3"))
    giveBodypartUnlessSame(GlobalRegistry.createBodypart("messyhair"))
    var penis = GlobalRegistry.createBodypart("knottedequinepenishyperable")
    penis.lengthCM = 65
    penis.ballsScale = 1
